...
In this chapter, we firstly introduce the hardware architecture and the data type characteristics of the DSP board. Secondly, program execution efficiency optimization guidelines are presented. Finally, choices and considerations about the C program implemented on the DSP board are recorded in the third section.
