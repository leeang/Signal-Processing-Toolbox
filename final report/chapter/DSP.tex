...
\subsection{Statistical Profiler}

\subsection{\texttt{time.h} Library}
...
Frame energy is calculated in fixed-point arithmetic (\fullref{subsection:dsp-thresholds}).\\

Special data structures are designed for sparse matrices, such as Mel-bank filter gain shown in Fig. \ref{mel_filter_bank_gain} on page \pageref{mel_filter_bank_gain} and transition matrices shown in Fig. \ref{fig 5} on page \pageref{fig 5}.
