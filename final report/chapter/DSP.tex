...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{ang/mel_filter_bank_gain}
...
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=\textwidth]{ang/probability_comparison}
\caption{Result Comparison}
\label{probability_comparison}
\end{minipage}
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=\textwidth]{ang/probability_error}
