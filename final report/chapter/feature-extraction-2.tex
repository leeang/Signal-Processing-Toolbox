...
Fig. \ref{threshold_example1} shows the waveform of word \textit{zero} and corresponding frame energy as well as frame zero-crossing count. Fig. \ref{threshold_example2} is a zoomed-in version of Fig. \ref{threshold_example1}.
...
We manually identify the unvoiced and voiced region of the 3-second recording by hearing the sound and observing the waveform. The green dash-dot rectangle indicates the unvoiced region while the red dash rectangle shows the voiced region.
