...
\newcommand*{\minipagepng}[1]{\includegraphics[width=\textwidth, trim={4.58cm 2.5cm 4.58cm 2.5cm}, clip]{#1}}
...
\pagestyle{fancy}
\lhead{\footnotesize EW2 Voice-controlled Television}
\chead{}
\rhead{\footnotesize Final Report}
